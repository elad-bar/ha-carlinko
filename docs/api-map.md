...
| GET    | `/user/notice/unReadCount?vehicleId=`                  | Notification counts                         | Category tiles (`vehicleNoticeVo`, `controlNoticeVo`, …). Integration uses types **2** and **4** only.                                                                                                                                                                                                                                                                                                                                                                    |
| GET    | `/user/notice/page?page&size&type&vehicleId=`          | Notice list                                 | Row includes title/contents; no separate body GET. HA fires `carlinko_notice` for new operational rows.                                                                                                                                                                                                                                                                                                                                                                   |
