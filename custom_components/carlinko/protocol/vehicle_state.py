...
from .consts import (
    ...
    DEFAULT_BATTERY_KWH, DEFAULT_CHEMISTRY, DEFAULT_CURRENCY, DEFAULT_TPMS_SCALE,

    EMPTY_VEHICLE_STATE, KNOWN_CAR_OVERRIDES,
...
class VehicleState:
    ...
    def update_metadata(self, creds):
        ...
        self._powertrain_cfg = (creds.get("powertrain") or known.get("powertrain") or "auto").lower()
        ...
        self.data.update({
            ...
            "battery_kwh": float(
                ...
                creds.get("battery_kwh") or known.get("battery_kwh") or DEFAULT_BATTERY_KWH
            ...
            "tariff": (
                ...
                creds.get("tariff") if creds.get("tariff") is not None else creds.get("tariff_idr")
