...
ENTITY_SPECS: tuple[EntitySpec, ...] = (
    ...
    EntitySpec(
        key="windshield_heat",
        platform="switch",
        name="Windshield heat",
        data_path="windshield_heat",
        icon="mdi:car-windshield",
        when="cap:windshieldHeat",
        commands={"on": "742301", "off": "742300"},
    ),
    EntitySpec(
        key="steer_heat",
        platform="switch",
        name="Steering wheel heat",
        data_path="steer_heat",
        icon="mdi:steering",
        when="cap:steerHeat",
        commands={"on": "742401", "off": "742400"},
    ),
    # Seats: live blob (rear L vent 39 inferred; rest dash- or opcode-confirmed).
    EntitySpec(
        key="seat_heat_l",
        platform="select",
